...
.map-wrapper {
    ...
    box-shadow:
        0 10px 32px rgba(25, 35, 45, 0.10);
}
...
.map-overlay {
    ...
    border:
        1px solid rgba(110, 118, 126, 0.20);

    backdrop-filter: blur(18px) saturate(120%);
    -webkit-backdrop-filter: blur(18px) saturate(120%);

    box-shadow:
        0 5px 18px rgba(20, 30, 40, 0.10);
}
...
.map-info-card {
    ...
    background:
        rgba(248, 249, 250, 0.78) !important;

    border:
        1px solid rgba(110, 118, 126, 0.25) !important;
...
.map-info-separator {
    ...
    background:
        rgba(100, 108, 116, 0.16) !important;
}
...
.map-coordinate-item + .map-coordinate-item {
    border-left:
        1px solid rgba(100, 108, 116, 0.14);
